...
export const getMyPayments = async (searchParams?: Record<string, string | undefined>): Promise<IListRes<IPayment>> => {
  ...
  try {
    ...
    return { success: false, message: "Failed to fetch payments", data: [], metaData: { page: 1, limit: 5, total: 0, totalPage: 0 } };
  }
};
